#define BLYNK_TEMPLATE_ID "TMPL6kuouDHui"
#define BLYNK_TEMPLATE_NAME "Monitor"
#define BLYNK_AUTH_TOKEN "5f7gTX5rrvnGybRclfHiKw6G13JHVd1"
#include <ESP8266WiFi.h>
#include <BlynkSimpleEsp8266.h>
char ssid[] = "KOST_AYRA"; // Your WiFi SSID
char password[] = "ayrapucang"; // Your WiFi password char auth[] = BLYNK_AUTH_TOKEN;
BlynkTimer timer;
WiFiClient client;
int trigPin
int echoPin
...
5; // Pin connected to the water pump relay
4; // Pin connected to the water relay
int relay_water = 4;
BLYNK WRITE(V2) {
}
// Get the value of the virtual pin
int pinValue = param.asInt();
digitalWrite(relay_pump, pinValue); // Turn on/off the water pump
BLYNK_WRITE(V3) {
}
// Get the value of the virtual pin
int pinValue = param.asInt();
digitalWrite(relay_water, pinValue); // Turn on/off the water
void connectToWiFi() {
Serial.println();
Serial.println();
